/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: bdc114cdd9a1cd41906d0dad0ede446d)
// Runtime types generated with workerd@1.20260508.1 2026-05-14 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		DB: D1Database;
		ASSETS: Fetcher;
		PUBLIC_APP_URL: "https://auth.alau.at";
		PUBLIC_APP_NAME: "ALAU Auth";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_APP_URL" | "PUBLIC_APP_NAME" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "DATABASE_URL" | "ORIGIN" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY">> {}
}
